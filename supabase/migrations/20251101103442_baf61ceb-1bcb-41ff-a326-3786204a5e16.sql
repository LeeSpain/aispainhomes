-- Create function to sync questionnaire to profile
...
-- Create trigger
DROP TRIGGER IF EXISTS sync_questionnaire_to_profile_trigger ON questionnaire_responses;
CREATE TRIGGER sync_questionnaire_to_profile_trigger
AFTER INSERT OR UPDATE ON questionnaire_responses
FOR EACH ROW
EXECUTE FUNCTION sync_questionnaire_to_profile();