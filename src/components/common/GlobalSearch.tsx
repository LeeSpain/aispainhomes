...
const GlobalSearch = () => {
  ...
  const renderAuthRequired = () => (
    <div className="p-8 text-center">
      ...
      <h3 className="text-lg font-semibold mb-2">Create an Account to Search</h3>
      <p className="text-muted-foreground mb-4">
        Register to unlock our powerful property search tools and find your dream home in Spain.
      </p>
      <Button onClick={() => {
        navigate('/register');
        setIsOpen(false);
